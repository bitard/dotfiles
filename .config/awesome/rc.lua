...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey }, "Print", function () awful.util.spawn("scrot '%Y-%m-%d_$wx$h.png' -e 'mv $f ~/shots/'") end),
 -- Dropdown terminal & musicplayer
    awful.key({ modkey,           }, "z",      function () drop(terminal) end),
    awful.key({ modkey,           }, "p",      function () drop(musicplr) end),
    ...
    awful.key({ altkey }, "Up",
        function ()
            awful.util.spawn("amixer -q set PCM 3%+")
            volumewidget.update()
        end),
    ...
    awful.key({ altkey }, "m",
        function ()
            awful.util.spawn("amixer -q set PCM playback toggle")
            volumewidget.update()
        end),
    awful.key({ altkey, "Control" }, "m",
        function ()
            awful.util.spawn("amixer -q set PCM playback 100%")
            volumewidget.update()
        end),
